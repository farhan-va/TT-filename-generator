...
def onCopyClick():
    ...
    if txn.get() == "":
        blankFlag = True
    ttStr += amountStr + " " + transactee.get() + " - Bank ref " + \
...
tt = "TT"
# Main frame
mainFrame = Frame(win, padx=7, pady=7, bg='#89E3F8')
mainFrame.place(relx=0.5, rely=0.5, anchor=CENTER)
# Inputs frame
inputsFrame = Frame(mainFrame, padx=7, pady=7, bg='#89E3F8')
inputsFrame.grid(row=0, column=0)
# Header
headerLabel = Label(win, text="TT Filename Generator", font=(
    "Consolas", 18), bg='#89E3F8', fg="dark blue", padx=10, pady=15)
headerLabel.place(relx=0.5, anchor=N)
# Footer
footerLabel = Label(
    win, text="Made by Farhan Arshad\nVersion 0.7", bg='#89E3F8', fg="grey", padx=7, pady=7)
footerLabel.place(relx=1, rely=1, anchor=SE)
# Company
company = StringVar()
companyLabel = Label(inputsFrame, text="Company: ", pady=7, bg='#89E3F8')
...
# TT Code
ttCode = StringVar()
ttCodeLabel = Label(inputsFrame, text="TT Code: ", bg='#89E3F8')
...
div = StringVar()
divLabel = Label(inputsFrame, text="Division (for SQCC only): ", bg='#89E3F8')
...
# Bank
bank = StringVar()
bankLabel = Label(inputsFrame, text="Bank: ", bg='#89E3F8')
...
# Currency
cur = StringVar()
curLabel = Label(inputsFrame, text="Currency: ", bg='#89E3F8')
...
# Amount
amount = StringVar()
amountLabel = Label(inputsFrame, text="Amount: ", bg='#89E3F8')
...
transacteeLabel = Label(inputsFrame, text="Vendor/Customer: ", bg='#89E3F8')
...
bankref = StringVar()
bankrefLabel = Label(inputsFrame, text="Bank ref.: ", bg='#89E3F8')
...
txn = StringVar()
txnLabel = Label(inputsFrame, text="Transaction no.: ", bg='#89E3F8')
...
# Txn description
txnDesc = StringVar()
txnDescLabel = Label(inputsFrame, text="Details: ", bg='#89E3F8')
...
# Date
date = StringVar()
dateLabel = Label(inputsFrame, text="Date (DD-MM-YYYY): ", bg='#89E3F8')
...
# Result indicator
outputLabel = Label(inputsFrame, text="", pady=10, bg='#89E3F8')
...
# Reset indicator
resetLabel = Label(inputsFrame, text="", pady=5, bg='#89E3F8')
resetLabel.grid(row=12, column=0)
# Output display
outputDisplayLabel = Label(mainFrame, text="File name: ", bg='#89E3F8')
